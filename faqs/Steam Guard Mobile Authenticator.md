...
* [Why am I not prompted for confirmation when I save my sign in credentials in Steam?](#noprompt)
...
#### Why should I add a phone number to my Steam account?
...
It's a good idea to print out a set of [backup codes](https://store.steampowered.com/twofactor/manage) that you can use in an emergency.  
...
####  Why isn't my phone number working?
...
#### Why is my number being blocked because it's considered VoIP?
...
#### Why am I not prompted for confirmation when I save my sign in credentials in Steam?
...
You may choose not to let Steam remember your credentials and require your password (and potentially confirmation) on every sign in. You can change this in Steam's client settings under the Security tab anytime by by enabling the setting at the top that says, "Don't save account credentials on this computer."  
