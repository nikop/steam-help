...
**More detailed information can be found here:** [**Scam: I  have been reported**](https://help.steampowered.com/en/faqs/view/3195-9FFB-BA06-F25B)    
...
* [What specific trading scams should I be aware of?](#whatscams)
...
[h5]What is a confidence scam?[/h5]  
...
[h5]What scam types might target Steam users?[/h5]Most scams targeting Steam users (unrelated to Trade Scams) involve an attempt to gain control of a victim's account and then hold the account hostage for payment.   
...
[h5]How do I protect myself from scams?[/h5]  
...
[h5]What do I do if I've fallen for a scam?[/h5]If you've given away control of your account to a scammer, you should immediately take steps to [recover the account through Steam Support](https://help.steampowered.com/en/wizard/HelpWithAccountStolen). Despite what a scammer might claim, you can **always** recover your account through Steam Support even if the scammer has changed all of the account's information including its password, email, and phone number.  
  
[h5]My account has been accidently or falsely reported. What do I need to do?[/h5]You don't need to do anything to protect your account from false or mistaken reports. They're simply disregarded by the Steam team.  
  
[h5]What should I do if I receive a suspicious message from a friend?[/h5]You can use Steam's reporting tools on your friend's Steam Community profile page to report your friend's account as hijacked. If the hijacking can be confirmed, Steam's moderation team will lock the account until the owner is able to recover it.  
  
[h5]How do I report a scammer?[/h5]Most confidence scams take place largely outside of Steam. To report the scammer, you should use the reporting feature of the platform that the scammer is using to chat with you, and your should also block all further communication.  
...
[h5]What is a trade scam?[/h5]A trade scam is when a Steam user convinces another user to make a deal (trade, gift or market transaction) under false pretenses. Scams usually involve deception in order to convince a user that they are getting a good or fair deal when in fact they are not.  
...
[h5]What are the best ways to avoid getting scammed?[/h5]
...
[h5]What kind of trades should I avoid?[/h5]Do *not* trade for anything that cannot be added into the Steam trading window. The most common examples of these types of trades include:  
...
[h5]What specific trading scams should I be aware of?[/h5]Users should always double check the contents of a proposed trade before accepting, even if that means inspecting each item in a multiple-item trade. Be sure to verify the item and its quality before confirming any trade.  
...
[h5]How do I report a scammer?[/h5]If you've been scammed or another user has attempted to scam you, please use the Report feature built into Steam. This is the best way to bring scammers to our attention so we may take action:  
...
[h5]Why doesn't Steam return scammed items?[/h5]Our community assigns an item a value that is at least partially determined by that item's scarcity. If more copies of the item are added to the economy through inventory rollbacks, the value of every other instance of that item would be reduced.  
  
We sympathize with people who fall victim to scams, but we provide enough information on our website and within our trading system to help users make good trading decisions. For more information on this, please see [this post](http://store.steampowered.com/news/20631/) on our store blog.  
  
[h5]Why won't Steam Support provide information on why an account was trade banned or locked?[/h5]By limiting the provided data, Steam Support prevents malicious users from learning how to avoid getting caught in the future. Steam Support relies on several data points to arrive at a decision to ban or lock an account. Users intent on committing malicious activity, most often done to other users, are constantly trying to gain this data to use in future scams, fraud and hijackings.  
